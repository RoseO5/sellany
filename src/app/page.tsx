    ...
    <div className="min-h-screen bg-white">
      <header className="bg-gray-900 text-white py-6">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mt-2">
            Sell goods & services — shoes, bags, human hair, clothes, baking,
            painting & more!
          </p>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Buy and sell anything — from fashion to freelance services.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="mt-2 text-gray-700">
              List shoes, bags, human hair, clothes, or offer services like
              baking & painting.
            </p>
          </a>
          ...
          >
            <h3 className="text-xl font-medium text-green-
